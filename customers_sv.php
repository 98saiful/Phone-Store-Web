...
<head>
 <meta charset="utf-8">
  ...
  <title>Google Store : Customers</title>
  <!-- Bootstrap -->
...
<div class="container-fluid">
  ...
  <form action="customers.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
          <label for="productid" class="col-sm-3 control-label"> Customers ID</label>
          <div class="col-sm-9">
      <input name="cid" type="text" class="form-control" placeholder="Customers ID" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_num']; ?>" required> 
    </div>
  </div>
      <div class="form-group">
          <label for="productid" class="col-sm-3 control-label">First Name</label>
          <div class="col-sm-9">
      <input name="fname" type="text" class="form-control" placeholder="First Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_fname']; ?>" required>
    </div>
  </div>
     ...
     <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="lname" class="form-control" placeholder="Last Name" type="text" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_lname']; ?>"required> 
    </div>
  </div>
     <div class="form-group">
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_customers_a166118_pt2");
        $stmt->execute();
